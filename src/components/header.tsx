...
export default function Header({ pathname }: { pathname: string }) {
  return (
    <header className="text-gray-100">
      <nav className="bg-gray-800 flex justify-center items-center w-[200px] h-[50px] rounded-full divide-x-4 divide-[#9F8C76]/70 shadow-xl border-b-4 border-gray-700">
        <Link
